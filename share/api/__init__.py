...
__all__ = [
    'update', 'download', 'drop_tables',
    'is_open', 'get_all_symbols',
    'get_stocks_base', 'get_daily',
...
def _check_dofunc_item(dofunc_item, enum):
    ...
    if isinstance(dofunc_item, DoFuncItem):
        ...
        raise TypeError('dofunc_item not a DoFuncItem or a valid string: {}'.format(update_item))
    return di
